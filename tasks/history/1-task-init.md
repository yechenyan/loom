...
- Added a local install command and CLI entrypoint:
  `uv run python /Users/user/Documents/code2/loom/scripts/loom.py install`
- Added manual scan and route commands:
  `uv run python /Users/user/Documents/code2/loom/scripts/loom.py scan energy`
  `uv run python /Users/user/Documents/code2/loom/scripts/loom.py route "loom scan energy" --workspace-root /Users/user/Documents/code2/loom`
- Added and updated tests for chat parsing, CSV profiling, scanner behavior, and install flow.
- Documented the project usage in `docs/reference/loom-reference.md`.
