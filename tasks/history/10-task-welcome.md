...
- Reworked the top section of [web/src/App.jsx](/Users/maxiao/Documents/code2/loom/web/src/App.jsx) into a Chinese AI-chat-style onboarding flow.
...
- Refreshed [web/src/styles.css](/Users/maxiao/Documents/code2/loom/web/src/styles.css) to support the new chat UI, tabs, copy action, and polished onboarding layout.
- Updated [README.md](/Users/maxiao/Documents/code2/loom/README.md) and [docs/reference/loom-reference.md](/Users/maxiao/Documents/code2/loom/docs/reference/loom-reference.md) so the docs match the new AI-assisted install and onboarding flow.
